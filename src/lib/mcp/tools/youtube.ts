...
export const youtubeTools: ToolDefinition[] = [
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/channels?${new URLSearchParams({
    ...
    }),
    {
        ...
        handler: async (params, context) => {
            ...
            if (params.pageToken)
                query.set("pageToken", params.pageToken as string);
            // search.list only supports snippet; fetch full details via videos.list
            const searchResult = await youtubeFetch(context.serviceConnectionId, `/search?${query.toString()}`) as {
                items?: Array<{
                    id?: {
                        videoId?: string;
                    };
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/videos?${new URLSearchParams({
    ...
    },
    {
        ...
        handler: async (params, context) => {
            ...
            if (fields.tags)
                snippet.tags = fields.tags;
            if (fields.categoryId)
                snippet.categoryId = fields.categoryId;
            ...
            if (fields.privacyStatus)
                body.status = { privacyStatus: fields.privacyStatus };
            const parts: string[] = [];
            if (body.snippet)
                parts.push("snippet");
            if (body.status)
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/videos?${new URLSearchParams({ id: String(params.videoId) }).toString()}`,
        method: "DELETE",
    }),
    {
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/playlists?${new URLSearchParams({
            part: "snippet,contentDetails,status",
            id: String(params.playlistId),
        }).toString()}`,
    }),
    {
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/playlists?${new URLSearchParams({ id: String(params.playlistId) }).toString()}`,
        method: "DELETE",
    }),
    {
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/playlistItems?${new URLSearchParams({ id: String(params.playlistItemId) }).toString()}`,
        method: "DELETE",
    }),
    {
        name: "youtube_search",
    ...
    // ─── YouTube additional tools ──────────────────────────────────────────
    {
        ...
        handler: async (params, context) => {
            ...
            if (fields.title)
                channel.title = fields.title;
            if (fields.description)
                channel.description = fields.description;
            if (fields.keywords)
                channel.keywords = fields.keywords;
            if (fields.country)
                channel.country = fields.country;
            if (fields.defaultLanguage)
                channel.defaultLanguage = fields.defaultLanguage;
            const parts: string[] = [];
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => `/captions?${new URLSearchParams({
            part: "snippet",
    ...
    }),
    {
        ...
        handler: async (params, context) => {
            const query = new URLSearchParams();
            if (params.tfmt)
                query.set("tfmt", params.tfmt as string);
            const qs = query.toString();
            return youtubeFetch(context.serviceConnectionId, `/captions/${params.captionId}${qs ? `?${qs}` : ""}`, undefined, { responseType: "text" });
        },
    },
    {
    ...
    },
    {
        ...
        handler: async (params, context) => {
            ...
            if (fields.position !== undefined)
                snippet.position = fields.position;
            if (Object.keys(snippet).length > 0)
                body.snippet = snippet;
            if ((fields.playlistIds as string[] | undefined)?.length)
                body.contentDetails = { playlists: fields.playlistIds };
            const parts: string[] = [];
            if (body.snippet)
                parts.push("snippet");
            if (body.contentDetails)
                parts.push("contentDetails");
            if (parts.length === 0)
                throw new Error("At least one field to update is required");
            const query = new URLSearchParams({ part: parts.join(",") });
    ...
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => {
            ...
            if (params.hl)
                query.set("hl", String(params.hl));
            return `/i18nLanguages?${query.toString()}`;
        },
    }),
    createFetchTool(youtubeFetch, {
        ...
        path: (params) => {
            ...
            if (params.hl)
                query.set("hl", String(params.hl));
            return `/i18nRegions?${query.toString()}`;
        },
    }),
    {
        ...
        handler: async (params, context) => {
            ...
            if (params.pageToken)
                query.set("pageToken", params.pageToken as string);
            if (params.filterByMemberChannelId)
                query.set("filterByMemberChannelId", params.filterByMemberChannelId as string);
            if (params.hasAccessToLevel)
                query.set("hasAccessToLevel", params.hasAccessToLevel as string);
    ...
    createFetchTool(youtubeFetch, {
        ...
        inputSchema: z.object({}),
        path: "/membershipsLevels?part=snippet",
    }),
    {
